...
xtitle('Deuteron under Lennard-Jones(12-6) potential','r in fm','Energy in MeV')
aa=gca
aa.data_bounds=[0.3,min(V1/10^6);1,2000]
...
title("u for Lennard_Jones(12-6) potential")
aaa=gca
...
title("Probability Density for Lennard_Jones(12-6)")
aaa=gca
aaa.x_label.font_size = 4
aaa.y_label.font_size = 4
aaa.title.font_size = 4
