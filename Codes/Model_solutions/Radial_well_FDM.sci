...
//Parameters in the potential well
L=2.32*10^-15//Potential well width in m
V0=-29.2*10^6//Depth of the potential well in eV
...
scf(0)
clf
plot(x/(10^-15),V1/(10^6),'b','LineWidth',4)
xtitle('Radial well potential','r in fm','Energy in MeV')
axis=gca()
axis.x_label.font_size = 4
axis.y_label.font_size = 4
axis.title.font_size = 4
axis.data_bounds(2)= 5
axis.data_bounds(3)=-35
axis.data_bounds(4)= 1
axis.font_size = 4    
...
title("u for Radial well potential")
aaa=gca
...
title("Probability Density for Radial well potential")
aaa=gca
aaa.x_label.font_size = 4
aaa.y_label.font_size = 4
aaa.title.font_size = 4
